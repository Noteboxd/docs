---
title: "Search the Noteboxd API: Fragrances, Brands, and Notes"
sidebarTitle: "Search"
description: "Use the Noteboxd universal search endpoint to find fragrances, brands, notes, perfumers, and collections by keyword across the full database."
---
